...
dg = iup.dialog{iup.label{title="Tray example"}; title="Tray", 
          tray = "YES", traytip =  "This is a tip", trayimage = tecgraf}
dg:show()
dg.hidetaskbar = "YES"
dg.trayclick = function(self, b, press, dclick)
  if b == 2 then 
    item_show = iup.item {title = "Show", action = function() dg:show() end}
    item_exit = iup.item {title = "Exit", action = function() dg.tray = "NO" return iup.CLOSE end}
