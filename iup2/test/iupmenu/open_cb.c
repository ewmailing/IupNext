...
int submnu_open_cb(Ihandle* self)
{
  printf("%s: OPEN_CB chamada!\n", IupGetAttribute(self, "TITLE"));
  return IUP_DEFAULT;
}
...
;
  ...
  IupSetFunction("submnu_open_cb", (Icallback) submnu_open_cb);
  submenu_help = IupSubmenu ("Help", menu_help) ;
  IupSetAttribute(submenu_help, IUP_OPEN_CB, "submnu_open_cb");
  IupSetAttribute(submenu_edit, IUP_OPEN_CB, "submnu_open_cb");
  IupSetAttribute(submenu_file, IUP_OPEN_CB, "submnu_open_cb");
