 ...
 *
 */
#ifndef __ComboBox1Widget_h
#define __ComboBox1Widget_h
...
typedef struct {
    ...
    int      item_position;	/* Index dieses Eintrages */
} XmComboBoxCallbackStruct,XmComboBoxDefaultActionCallbackStruct;
