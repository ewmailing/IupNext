...
static void iPlotSetClassUpdate(Iclass* ic)
{
  ...
  else if (iupStrEqualNoCase(IupGetGlobal("LANGUAGE"), "SPANISH"))
  {
    ...
    IupSetLanguageString("IUP_HOLLOW_BOX", "Cuadro Vacío");
    ...
    IupSetLanguageString("IUP_PIESTARTANGLE", "Ángulo de Inicio del Pastel:");
    IupSetLanguageString("IUP_PIECONTOUR", "Contorno del Pastel:");
    IupSetLanguageString("IUP_PIEHOLE", "Agujero del Pastel:");
    IupSetLanguageString("IUP_PIESLICELABEL", "Etiqueta de Porción de Pastel:");
    ...
    IupSetLanguageString("IUP_BOLDITALIC", "Negrita Itálica");

    IupSetLanguageString("IUP_POSITION", "Posición:");
    IupSetLanguageString("IUP_POSXY", "(x,y):");
    ...
    IupSetLanguageString("IUP_MIN", "Mínimo:");
    IupSetLanguageString("IUP_MAX", "Máximo:");
    ...
    IupSetLanguageString("IUP_SIZE", "Tamaño:");
    IupSetLanguageString("IUP_MAJOR", "Principal:");
    IupSetLanguageString("IUP_MINOR", "Secundario:");

    IupSetLanguageString("IUP_ROTATE", "Rotación:");
    IupSetLanguageString("IUP_ANGLE", "Ángulo:");
    ...
    if (IupGetInt(NULL, "UTF8MODE"))
    {
      ...
      IupSetLanguageString("IUP_ERRORINVALIDFORMULA", "FÃ³rmula InvÃ¡lida.");
      IupSetLanguageString("IUP_AREA", "Ãrea");
      IupSetLanguageString("IUP_MULTIBARS", "Barras MÃºltiples");
      IupSetLanguageString("IUP_HOLLOW_CIRCLE", "Circulo VacÃ­o");
      IupSetLanguageString("IUP_HOLLOW_BOX", "Cuadro VacÃ­o");
      IupSetLanguageString("IUP_HOLLOW_DIAMOND", "Diamante VacÃ­o");
      IupSetLanguageString("IUP_MARKSIZE", "TamaÃ±o de Marca:");
      IupSetLanguageString("IUP_AREATRANSPARENCY", "Transparencia de Ãrea:");
      IupSetLanguageString("IUP_PIESTARTANGLE", "Ãngulo de Inicio del Pastel:");
      IupSetLanguageString("IUP_PIESLICELABEL", "Etiqueta de PorciÃ³n de Pastel:");
      IupSetLanguageString("IUP_PIESLICELABELPOS", "Pos. de Etiqueta en la PorciÃ³n:");
      IupSetLanguageString("IUP_TITLE", "TÃ­tulo");
      IupSetLanguageString("IUP_AXISTICKSNUMBER", "NÃºmeros en las Marcas");
      IupSetLanguageString("IUP_WARNING", "Â¡Advertencia!");
      IupSetLanguageString("IUP_CHANGESNOTAPPLIEDAPPLY", "Hay Modificaciones. Â¿Aplicarlas?");
      IupSetLanguageString("IUP_FONTSIZE", "TamaÃ±o de Fuente:");
      IupSetLanguageString("IUP_ITALIC", "ItÃ¡lica");
      IupSetLanguageString("IUP_BOLDITALIC", "Negrita ItÃ¡lica");
      IupSetLanguageString("IUP_POSITION", "PosiciÃ³n:");
      IupSetLanguageString("IUP_MIN", "MÃ­nimo:");
      IupSetLanguageString("IUP_MAX", "MÃ¡ximo:");
      IupSetLanguageString("IUP_SIZE", "TamaÃ±o:");
      IupSetLanguageString("IUP_ROTATE", "RotaciÃ³n:");
      IupSetLanguageString("IUP_ANGLE", "Ãngulo:");
    }
  }
}
