...
{
  IupSetAttributeId2(ih,"MASK", lin, col, NULL);
}
...
{
  (void)autofill;
  IupSetfAttributeId2(ih,"MASKINT", lin, col, "%d:%d", min, max);
  return 1;
}
...
{
  (void)autofill;
  IupSetfAttribute(ih,"MASKFLOAT", "%.6f:%.6f", min, max);
  return 1;
}
...
{
  (void)autofill;
  IupSetfAttributeId2(ih,"MASKFLOAT", lin, col, "%.6f:%.6f", min, max);
  return 0;
}
