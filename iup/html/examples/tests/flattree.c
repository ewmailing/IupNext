...
static void init_tree_nodes(void)
{
  ...
  //  IupSetAttribute(tree, "AUTOREDRAW", "Yes");
	...
	IupSetAttribute(tree, "NODEBGCOLOR3", "0 255 0");
	IupSetAttribute(tree, "NODEBGCOLOR4", "0 255 0");
	IupSetAttribute(tree, "NODEBGCOLOR5", "0 255 0");

	IupSetAttribute(tree, "NODEFGCOLOR4", "255 0 0");
	IupSetAttribute(tree, "NODEFGCOLOR5", "255 0 0");
	IupSetAttribute(tree, "NODEFGCOLOR6", "255 0 0");

	IupSetAttribute(tree, "NODEFONTSTYLE3", "Bold");
...
//	IupSetAttributeHandle(tree, "BACKIMAGE", bimage);
  ...
  /* create from top to bottom */
	...
	if (!IupGetInt(tree, "ADDROOT"))
		...
		IupSetAttribute(tree, "TITLE0", "NFL");
...
//	IupSetAttribute(tree, "FITTOBACKIMAGE", "YES");
	...
	IupSetAttribute(tree, "ADDROOT", "YES");
