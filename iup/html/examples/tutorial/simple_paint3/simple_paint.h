...
protected:
  ...
  Ihandle* CreateFileTab();
  Ihandle* CreateEditTab();
  Ihandle* CreateViewTab();
  Ihandle* CreateImageTab();
  Ihandle* CreateHelpTab();
  ...
  IUP_CLASS_DECLARECALLBACK_IFn(SimplePaint, DialogMinimizeCallback);
  IUP_CLASS_DECLARECALLBACK_IFn(SimplePaint, DialogMaximizeCallback);
