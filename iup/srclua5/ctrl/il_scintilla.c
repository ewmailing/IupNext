...
static int scintilla_insertcheck_cb(Ihandle *self, int p0, int p1, char * p2)
{
  lua_State *L = iuplua_call_start(self, "insertcheck_cb");
...
int iupscintillalua_open(lua_State * L)
{
  ...
  iuplua_register_cb(L, "INSERTCHECK_CB", (lua_CFunction)scintilla_insertcheck_cb, NULL);
