...
static int tuioclient_cursor_cb(Ihandle *self, int p0, int p1, int p2, int p3, char * p4)
{
  lua_State *L = iuplua_call_start(self, "cursor_cb");
...
int iuptuioclientlua_open(lua_State * L)
{
  ...
  iuplua_register_cb(L, "CURSOR_CB", (lua_CFunction)tuioclient_cursor_cb, NULL);
