...
static void gtkTabsUpdatePageFont(Ihandle* ih)
{
  ...
  {
    GtkWidget* tab_label = (GtkWidget*)iupAttribGetStr(child, "_IUPGTK_TABLABEL");
    if (tab_label)
    {
...
static void gtkTabsUpdatePageBgColor(Ihandle* ih, unsigned char r, unsigned char g, unsigned char b)
{
  ...
  for (child = ih->firstchild; child; child = child->brother)
  {
    GtkWidget* tab_page = (GtkWidget*)iupAttribGetStr(child, "_IUPTAB_CONTAINER");
    if (tab_page)
    {
      GtkWidget* tab_label = (GtkWidget*)iupAttribGetStr(child, "_IUPGTK_TABLABEL");
      if (tab_label)
...
static int gtkTabsSetTabImageAttrib(Ihandle* ih, const char* name_id, const char* value)
{
  ...
  {
    Ihandle* child = IupGetChild(ih, pos);
    GtkWidget* tab_image = (GtkWidget*)iupAttribGetStr(child, "_IUPGTK_TABIMAGE");
    if (tab_image)
    {
...
void gtkTabSwitchPage(GtkNotebook* notebook, GtkNotebookPage *page, int pos, Ihandle* ih)
{
  ...
  if (iupAttribGetStr(ih, "_IUPGTK_IGNORE_CHANGE"))
    return;
...
void iupdrvTabsInitClass(Iclass* ic)
{
  ...
  /* Common */
  iupClassRegisterAttribute(ic, "STANDARDFONT", NULL, gtkTabsSetStandardFontAttrib, IupGetGlobal("DEFAULTFONT"), IUP_NOT_MAPPED, IUP_INHERIT);

  /* Visual */
  iupClassRegisterAttribute(ic, "BGCOLOR", NULL, gtkTabsSetBgColorAttrib, IupGetGlobal("DLGBGCOLOR"), IUP_MAPPED, IUP_INHERIT);
  iupClassRegisterAttribute(ic, "FGCOLOR", NULL, gtkTabsSetFgColorAttrib, "0 0 0", IUP_MAPPED, IUP_INHERIT);  /* black */

  /* IupTabs only */
  iupClassRegisterAttribute(ic, "TABTYPE", iupTabsGetTabTypeAttrib, gtkTabsSetTabTypeAttrib, "TOP", IUP_NOT_MAPPED, IUP_NO_INHERIT);
  iupClassRegisterAttribute(ic, "TABORIENTATION", iupTabsGetTabOrientationAttrib, gtkTabsSetTabOrientationAttrib, "HORIZONTAL", IUP_NOT_MAPPED, IUP_NO_INHERIT);
  iupClassRegisterAttribute(ic, "TABTITLE", NULL, (IattribSetFunc)gtkTabsSetTabTitleAttrib, NULL, IUP_MAPPED, IUP_NO_INHERIT);
  iupClassRegisterAttribute(ic, "TABIMAGE", NULL, (IattribSetFunc)gtkTabsSetTabImageAttrib, NULL, IUP_MAPPED, IUP_NO_INHERIT);
  iupClassRegisterAttribute(ic, "PADDING", iupTabsGetPaddingAttrib, gtkTabsSetPaddingAttrib, "0x0", IUP_NOT_MAPPED, IUP_INHERIT);
}
