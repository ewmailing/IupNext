...
static void iFlatTreeUpdateNodeCacheRec(Ihandle *ih, iFlatTreeNode *node, int *next_posy, int level)
{
	...
	while (brother)
	{
		...
		iFlatTreeSetNodeDrawFont(ih, brother->font);    //TODO otimizar
		...
		if (iFlatTreeNodeIsVisible(brother))  //TODO otimizar
		{
			brother->y = *next_posy;
...
//static void iFlatTreeSelectRange(Ihandle* ih, iFlatTreeNode *node1, iFlatTreeNode *node2, int clear)
//{
//	int i;
//	int id1 = iFlatTreeFindNodeId(ih->data->node_cache, node1);
//	int id2 = iFlatTreeFindNodeId(ih->data->node_cache, node2);
...
//	{
//		iFlatTreeNode *nodeFocus = iFlatTreeGetNode(ih, ih->data->focus_id);
//		iFlatTreeSelectRange(ih, (iFlatTreeNode*)iupAttribGet(ih, "_IUPFLATTREE_MARKSTART_NODE"), nodeFocus, 0);
//	}
...
//	else
//	{
//		iFlatTreeNode *node1, *node2;

//		char str1[50], str2[50];
//		if (iupStrToStrStr(value, str1, str2, '-') != 2)
//			return 0;

//		node1 = iFlatTreeGetNodeFromString(ih, str1);
//		if (!node1)
//			return 0;
//		node2 = iFlatTreeGetNodeFromString(ih, str2);
//		if (!node2)
//			return 0;

//		iFlatTreeSelectRange(ih, node1, node2, 0);
//	}
...
//{
//	iFlatTreeNode *node = iFlatTreeGetNodeFromString(ih, value);
//	if (!node)
//		return 0;

//	iupAttribSet(ih, "_IUPFLATTREE_MARKSTART_NODE", (char*)node);
