...
IUP_API Ihandle* IupLayoutDialog(Ihandle* dialog)
{
  ...
  if (!layoutdlg->destroy && iupAttribGet(dialog, "_IUPLED_FILENAME"))
  {
    ...
    Ihandle* new_elem_box = IupVbox(
      IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_ArrowCursor, TIP=\"Select elements on layout.\nThe other options are only part of the IUP available classes,\nother classes can be selected at the dialog from the context menu\", NAME=TOGGLE_SELECT"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
      IupSetAttributes(IupFlatSeparator(), "RASTERSIZE=x14, ORIENTATION=HORIZONTAL"),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Hbox, TIP=\"Insert a Hbox at cursor when click at layout or double click at tree \", _IUP_CLASS=hbox"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Vbox, TIP=\"Insert a Vbox at cursor when click at layout or double click at tree \", _IUP_CLASS=vbox"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Zbox, TIP=\"Insert a Zbox at cursor when click at layout or double click at tree \", _IUP_CLASS=zbox"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Cbox, TIP=\"Insert a Cbox at cursor when click at layout or double click at tree \", _IUP_CLASS=cbox"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_GridBox, TIP=\"Insert a GridBox at cursor when click at layout or double click at tree .\nPress Shift to select a MultiBox\", _IUP_CLASS=gridbox, _IUP_CLASS_ALT=multibox"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_ScrollBox, TIP=\"Insert a ScrollBox at cursor when click at layout or double click at tree .\nPress Shift to select a FlatScrollBox\", _IUP_CLASS=scrollbox, _IUP_CLASS_ALT=flatscrollbox"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Split, TIP=\"Insert a Split at cursor when click at layout or double click at tree \", _IUP_CLASS=split"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Expander, TIP=\"Insert a Expander at cursor when click at layout or double click at tree \", _IUP_CLASS=expander"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Fill, TIP=\"Insert a Fill at cursor when click at layout or double click at tree .\nPress Shift to select a Space\", _IUP_CLASS=fill, _IUP_CLASS_ALT=space"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_FlatSeparator, TIP=\"Insert a FlatSeparator at cursor when click at layout or double click at tree \", _IUP_CLASS=flatseparator"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Frame, TIP=\"Insert a Frame at cursor when click at layout or double click at tree .\nPress Shift to select a FlatFrame\", _IUP_CLASS=frame, _IUP_CLASS_ALT=flatframe"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Tabs, TIP=\"Insert a Tabs at cursor when click at layout or double click at tree .\nPress Shift to select a FlatTabs\", _IUP_CLASS=tabs, _IUP_CLASS_ALT=flattabs"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupSetAttributes(IupFlatSeparator(), "RASTERSIZE=x14, ORIENTATION=HORIZONTAL"),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Label, TIP=\"Insert a Label at cursor when click at layout or double click at tree .\nPress Shift to select a FlatLabel\", _IUP_CLASS=label, _IUP_CLASS_ALT=flatlabel"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Button, TIP=\"Insert a Button at cursor when click at layout or double click at tree .\nPress Shift to select a FlatButton\", _IUP_CLASS=button, _IUP_CLASS_ALT=flatbutton"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Toggle, TIP=\"Insert a Toggle at cursor when click at layout or double click at tree .\nPress Shift to select a FlatToggle\", _IUP_CLASS=toggle, _IUP_CLASS_ALT=flattoggle"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Radio, TIP=\"Insert a Radio at cursor when click at layout or double click at tree \", _IUP_CLASS=radio"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_List, TIP=\"Insert a List at cursor when click at layout or double click at tree .\nPress Shift to select a FlatList\", _IUP_CLASS=list, _IUP_CLASS_ALT=flatlist"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Tree, TIP=\"Insert a Tree at cursor when click at layout or double click at tree .\nPress Shift to select a FlatTree\", _IUP_CLASS=tree, _IUP_CLASS_ALT=flattree"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Val, TIP=\"Insert a Val at cursor when click at layout or double click at tree .\nPress Shift to select a FlatVal\", _IUP_CLASS=val, _IUP_CLASS_ALT=flatval"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_ProgressBar, TIP=\"Insert a ProgressBar at cursor when click at layout or double click at tree .\nPress Shift to select a Gauge\", _IUP_CLASS=progressbar, _IUP_CLASS_ALT=gauge"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Text, TIP=\"Insert a Text at cursor when click at layout or double click at tree .\nPress Shift to select a Multiline\", _IUP_CLASS=text, _IUP_CLASS_ALT=multiline"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Canvas, TIP=\"Insert a Canvas at cursor when click at layout or double click at tree .\nPress Shift to select a GLCanvas\", _IUP_CLASS=canvas, _IUP_CLASS_ALT=glcanvas"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      IupSetAttributes(IupFlatSeparator(), "RASTERSIZE=x14, ORIENTATION=HORIZONTAL"),
      IupHbox(
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Matrix, TIP=\"Insert a Matrix at cursor when click at layout or double click at tree .\nPress Shift to select a MatrixEx\", _IUP_CLASS=matrix, _IUP_CLASS_ALT=matrixex"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        IupSetCallbacks(IupSetAttributes(IupFlatToggle(NULL), "CHECKSIZE=0, IMAGE=_IUP_NAME_IMG_Plot, TIP=\"Insert a Plot at cursor when click at layout or double click at tree \", _IUP_CLASS=plot"), "FLAT_ACTION", (Icallback)iLayoutElemOptionToggle_cb, NULL),
        NULL),
      NULL);
