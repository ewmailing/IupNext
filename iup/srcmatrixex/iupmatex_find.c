...
void iupMatrixExSetClassUpdateFind(Iclass* ic)
{
  ...
  if (iupStrEqualNoCase(IupGetGlobal("LANGUAGE"), "ENGLISH"))
  {
    ...
    IupSetLanguageString("IUP_NOT_FOUND", "Not found.");
    IupSetLanguageString("IUP_FOUND_AT", "Found at");
  ...
  else if (iupStrEqualNoCase(IupGetGlobal("LANGUAGE"), "PORTUGUESE"))
  {
    ...
    IupSetLanguageString("IUP_NOT_FOUND", "Não encontrado.");
    ...
    if (IupGetInt(NULL, "UTF8MODE"))
    {
      ...
      IupSetLanguageString("IUP_NOT_FOUND", "NÃ£o encontrado.");
