...
FOR %%u IN (src srccd srccontrols srcgl srcglcontrols srcplot srcmglplot srcscintilla srcim srcimglib srcole srcfiledlg srctuio srcweb srcledc srcview) DO call make_uname_lib.bat %%u %1 %2 %3 %4 %5 %6 %7 %8 %9
