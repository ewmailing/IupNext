...
REM FOR %%u IN (src srccd srccontrols srcpplot srcgl srcim srcole srctuio srcledc srcview srclua3 srclua5 srcconsole) DO call make_uname_lib.bat %%u %1 %2 %3 %4 %5 %6 %7 %8 %9                                  
