...
{
  Ihandle *dlg, *canvas, *box, *gbox, *glabel, *gsep;
  ...
  gbox = IupHbox(glabel, gsep, NULL);
  IupSetAttribute(gbox, "HORIZONTALALIGN", "ACENTER");
  IupSetAttribute(gbox, "VERTICALALIGN", "ATOP");
